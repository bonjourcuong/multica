      ...
      {tasks.length === 0 ? (
        ...
        <div className="space-y-1.5">
          {sortedTasks.map((task) => {
            ...
            const issue = isChat ? null : issueMap.get(task.issue_id);
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    {isChat ? (
                      <span className="inline-flex items-center gap-1 shrink-0 rounded-full bg-purple-100 px-2 py-0.5 text-[11px] font-medium text-purple-700 dark:bg-purple-900/30 dark:text-purple-300">
