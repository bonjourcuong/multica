...
type Task struct {
	...
	GlobalSessionID         string          `json:"global_session_id,omitempty"`         // non-empty for global-chat tasks (no workspace)
	GlobalChatMessage       string          `json:"global_chat_message,omitempty"`       // latest user message for the global-chat prompt
